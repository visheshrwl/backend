...
Serialization/deserialization speed and wire size for a typical API response payload.
...
```
JSON: ~500 bytes, 2ms serialize
Protobuf: ~150 bytes (3x smaller), 0.3ms serialize (6x faster)
```
