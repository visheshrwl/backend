...
Redis cache hit/miss latency and DB load reduction at varying hit rates.
...
```
No cache: 10ms/req, 100% DB load
80% hit rate: 2.4ms/req, 20% DB load
99% hit rate: 0.6ms/req, 1% DB load
```
