# 04-dns-and-load-balancing

## Problem

Dns And Load Balancing is a critical layer of the network stack with direct implications for backend latency, throughput, and reliability.
